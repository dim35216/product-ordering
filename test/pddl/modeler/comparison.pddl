...
(:init
    ...
    (available p12021)
    (available p23547)
    (= (changeover-time p23545 p23545) 10000000)
    ...
    (= (changeover-time p12020 p12020) 10000000)
    ...
    (= (changeover-time p12021 p12021) 10000000)
    ...
    (= (changeover-time p23547 p23547) 10000000)
)
