...
from src.experiment.utils import calculate_oct, get_changeover_matrix, build_graph, create_lp_instance
...
class TestUtils(unittest.TestCase):
    ...
    def test_get_changeover_matrix(self):
        ...
        df_matrix, campaigns_order = get_changeover_matrix(products, consider_side_constraints=False)
        print(df_matrix)
        print(campaigns_order)
        self.assertEqual(df_matrix.shape, (len(products), len(products)))
    ...
    def test_build_graph(self):
        ...
        products = {'23545', '16215', '12020', '15951', '23151', '23547'}
        edge_weights = build_graph(products, consider_side_constraints=False)
        # pprint(edge_weights)
